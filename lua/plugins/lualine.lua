    ...
    config = function()
        ...
        local function custom_theme()
            ...
            if has_catppuccin then
                colors = require("utils.color").get_palette()
            ...
            gen_hl = function(fg, gen_bg, special_nobg, bg, gui)
                if has_catppuccin then
                    return function()
                        ...
                        local guibg = gen_bg and require("utils.color").hl_to_rgb("StatusLine", true, colors.mantle)
                            or colors[bg]
                        local nobg = special_nobg and require("config.scheme").transparent_background
                        return {
