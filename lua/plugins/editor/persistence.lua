...
return {
    ...
    keys = {
        ...
        {"<leader>sl", function() require("persistence").load() end, desc = "Session: load current"},
        ...
        end, desc = "Session: toggle auto save"},
        {"<leader>fs", function() require("persistence").select() end, desc = "Session: select to load"},
    },
