return {
    ...
    init = function() require("utils.core").load_plugin_with_func("nvim-notify", vim, "notify") end,
    opts = function(_, opts)
        ...
        opts.on_open = function(win)
            ...
            if core.is_available "nvim-treesitter" then require("lazy").load { plugins = { "nvim-treesitter" } } end
