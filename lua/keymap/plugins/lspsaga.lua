...
return function(bufnr)
    return {
        ...
        ["n|<leader>ld"] = map_cr("Lspsaga peek_defination"):with_silent():with_buffer(bufnr):with_desc("lsp: peek definition under cursor"),
        ["n|<leader>lD"] = map_cr("Lspsaga goto_defination"):with_silent():with_buffer(bufnr):with_desc("lsp: goto definition for cursor"),
