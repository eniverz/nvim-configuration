...
return function(bufnr)
    return {
        ...
        ["n|<leader>xx"] = map_cr("Lspsaga show_buf_diagnostics"):with_silent():with_buffer(bufnr):with_desc("lspsaga: goto prev diagnostic"),
        ["n|<leader>xX"] = map_cr("Lspsaga show_workspace_diagnostics"):with_silent():with_buffer(bufnr):with_desc("lspsaga: goto prev diagnostic"),
    }
end
