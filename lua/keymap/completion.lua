...
function mapping.lsp(buf)
    local map = {
        ...
        ["n|<leader>lo"] = map_cr("AerialToggle!"):with_silent():with_buffer(buf):with_desc("lsp: Toggle outline"),
        ...
        ["n|<leader>lr"] = map_cr("Lspsaga rename"):with_silent():with_buffer(buf):with_desc("lsp: Rename in file range"),
        ...
        ["n|<leader>lI"] = map_cr("Lspsaga incoming_calls")
            :with_silent()
            :with_buffer(buf)
